...
var GameView = (function (_super) {
    ...
    GameView.prototype.init = function (userBeans, arr) {


        var $this = this.boxBtn;
        // 金豆类型
        this.btnNumType = 100; //100,200,500,1000
         ...
         */
        // 投注按钮 -->投注金豆事件
        this.investBtn0.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn1.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn2.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn3.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn4.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn5.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn6.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn7.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn8.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn9.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn10.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn11.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn12.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn13.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn14.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn15.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn16.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn17.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn18.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn19.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn20.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn21.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn22.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn23.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn24.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn25.on(Laya.Event.CLICK, this, this.investClick);
        this.investBtn26.on(Laya.Event.CLICK, this, this.investClick);
    ...
    GameView.prototype.announcedClick = function () {
        ...
        Laya.timer.frameLoop(5, this, function () {
            ...
            b = b < 2 ? 6 : (b - 1);
            c = c < 6 ? (c + 1) : 1;
            this.dice1.loadImage("dice/s" + a + ".png");
            this.dice2.loadImage("dice/s" + b + ".png");
            this.dice3.loadImage("dice/s" + c + ".png");
    ...
    GameView.prototype.requestData = function () {
        ...
        http.send("data/result.json", pram, "get", "json");
        ...
        http.once(Laya.Event.COMPLETE, this, function (data) {
            ...
            this.dice1.loadImage("dice/s" + data.dice1 + ".png");
            this.dice2.loadImage("dice/s" + data.dice2 + ".png");
            this.dice3.loadImage("dice/s" + data.dice3 + ".png");

            var bean = "恭喜您获得" + data.bean + "金豆",
                sum = +(data.dice1) + (+(data.dice2)) + (+(data.dice3)),
                EO = sum % 2 == 1 ? "奇" : "偶",
                skin1 = "dice/r" + data.dice1 + ".png",
                skin2 = "dice/r" + data.dice2 + ".png",
                skin3 = "dice/r" + data.dice3 + ".png";
    ...
    GameView.prototype.noticeAntiate = function () {
        ...
        http.send("data/notice.json", pram, "get", "json");
        ...
        if (data.length == 0) {
            ...
            for (var i = 0; i < lenArr; i++) {
                ...
                if (icon == 0) {
                    ...
                    iconArr.push("dice/icon4.png");

                } else {

                    iconArr.push("dice/icon4s.png")
            ...
            function onRender(cell, index) {
                ...
                var sum = sumArr[index],
                    r1 = recordArr1[index],
                    r2 = recordArr2[index],
                    r3 = recordArr3[index],
                    icon = iconArr[index];

                var recordSum = cell.getChildByName("recordSum"),
                    record1 = cell.getChildByName("record1"),
                    record2 = cell.getChildByName("record2"),
                    record3 = cell.getChildByName("record3"),
                    recordIcon = cell.getChildByName("recordIcon");

                recordSum.text = sum;
                record1.text = r1;
                record2.text = r2;
                record3.text = r3;
                recordIcon.skin = icon;
